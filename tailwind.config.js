  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "fluid-base": "clamp(1rem, 0.9rem + 0.2vw, 1.125rem)",
        "fluid-lg": "clamp(1.125rem, 1rem + 0.3vw, 1.25rem)",
        "fluid-xl": "clamp(1.25rem, 1.1rem + 0.4vw, 1.5rem)",
        "fluid-2xl": "clamp(1.5rem, 1.25rem + 0.5vw, 1.875rem)",
        "fluid-3xl": "clamp(1.875rem, 1.5rem + 0.65vw, 2.25rem)",
